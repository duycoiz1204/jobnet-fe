...
export default function Resumes() {
  ...
  const [resumes, setResumes] = useState<ResumeType[]>(undefined!!);
    ...
    <Table className="table-fixed">
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="w-3/12">{t('resumes.table.access')}</TableHead>
          <TableHead className="w-4/12">{t('resumes.table.support')}</TableHead>
          <TableHead className="w-5/12"> {t('resumes.table.action')}</TableHead>
          <TableHead className="w-3/12">
